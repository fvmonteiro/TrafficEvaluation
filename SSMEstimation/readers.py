...
class SignalControllerFileReader(DataReader):
    ...
    def __init__(self, network_name):
        ...
        #                                        dir_name),
        #                     file_name)
        DataReader.__init__(self, self._vissim_networks_folder, network_name)
    ...
    def load_data(self, file_identifier: int) -> ET.ElementTree:
        ...
        :return:
        """
        relative_address = (file_handling.
            get_relative_address_from_network_name(self.network_name))
